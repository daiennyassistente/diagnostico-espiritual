...
## Implementação de Botão de Suporte WhatsApp

- [x] Criar componente reutilizável de botão WhatsApp flutuante
- [x] Implementar botão na página de início do quiz
- [x] Implementar botão na página de resultado
- [x] Implementar botão na página de oferta
- [x] Testar botão em todas as páginas
